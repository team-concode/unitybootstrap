    ...
    public class AseFileImporterEditor : UnityEditor.AssetImporters.ScriptedImporterEditor {
        ...
        public override void OnInspectorGUI() {
            ...
            EditorGUILayout.LabelField("Texture Options", EditorStyles.boldLabel);
            {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty(settings + "expandEdge"));
            ...
            if (importTypeProperty.intValue == (int) AseFileImportType.Sprite) {
                ...
                EditorGUILayout.PropertyField(serializedObject.FindProperty(settings + "fitSize"));
